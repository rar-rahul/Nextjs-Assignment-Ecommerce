...
const product = await res.json()
    ...
    <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl text-gray-700 font-semibold">Rs.{product.price}</p>
  ...
  <div className="space-y-2">
    <p className="text-lg font-medium text-gray-700">Category: <span className="text-indigo-600">{product.category}</span></p>
  </div>

  {/* Product Stock Information */}
  <div className="space-y-2">
    <p className="text-lg font-medium text-gray-700">Stock: 
